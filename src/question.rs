...
pub struct Question {
    ...
    /// Class     
    ///
    /// Defines what network class the question is asking for
    ...
    pub qclass: QClass,
    /// Set Question to multicast (QM, default) or unicast (QU)
    ///
    /// When probing the existence of records, QU is used so a host can defend its records directly
